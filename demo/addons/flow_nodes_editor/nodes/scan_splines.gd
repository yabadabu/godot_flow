...
func execute( ctx : FlowData.EvaluationContext ):
	...
	# downstream nodes (e.g. sample_spline) never null-deref on path.curve.
	nodes = nodes.filter( func( obj ): return obj.curve != null )
